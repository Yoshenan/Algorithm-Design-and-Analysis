...
// *********************************************************
//
// Demo step 3: reads dataset_n.csv plus a start row and end row,
// then writes dataset_<n>_heap_sorted_step_<start>_<end>.txt showing
// the array at every stage of the heap sort (max-heap).
//   - "initial" line  = the array AFTER build-max-heap
//   - "i = k" lines    = the array after each sort-phase pass
// Rows are 1-indexed and inclusive, matching the "_1_7" sample.
